...
function changeWorkspace(){const next=document.getElementById('workspaceSelect')?.value;if(!WORKSPACES[next])return;currentWorkspace=next;localStorage.setItem('mg2_workspace',currentWorkspace);updateWorkspaceUI();show('stock');load()}
